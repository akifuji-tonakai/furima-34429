  ...
  describe 'ユーザー新規登録' do
    ...
    context 'ユーザー登録出来ない' do
      ...
      it '名が半角英字だと登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Real first name Real first name Full-width characters")
      end
      ...
      it '姓が半角英字だと登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Real family name Real family name Full-width characters")
      end
      ...
      it '名のフリガナが半角英字だと登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("First furigana First furigana Full-width katakana characters")
      end
      ...
      it '姓のフリガナが半角英字だと登録できない' do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Family furigana Family furigana Full-width katakana characters")
      end

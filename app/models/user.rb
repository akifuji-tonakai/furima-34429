class User < ApplicationRecord
  devise :database_authenticatable, :registerable,
         ...
         with_options presence: true do
          ...
          validates :nickname
          validates :birthday
          validates :real_first_name, format: { with: /\A[ぁ-んァ-ン一-龥々]+\z/, message: "Full-width characters"} 
          validates :real_family_name, format: { with: /\A[ぁ-んァ-ン一-龥々]+\z/, message: "Full-width characters"}
